...
{\large Updated manual for LDSFL-Meander version 0.6.3\\[0.4em]}
{\normalsize \today}
\end{titlepage}
...
\noindent Lopez Dubon, S., Sgarabotto, A., Frascati, A., Lanzoni, S. (2026). LDSFL-Meander: A python code for a reduced two-dimensional morphodynamic model for meandering rivers. [\textit{Software}]. GitHub. doi: \texttt{10.5281/zenodo.19945291}
